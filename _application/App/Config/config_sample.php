...
//Each entry should have a corresponding index file (with an arbitrary real directory path) that includes the config file and (defines a controller and includes the loader) or (redirects with $forceRedirectUrl)
//It's possible to have user reachable index files that aren't represented in this array. They simply won't have a navigation link in the HTML header.
$sitePages = array(
