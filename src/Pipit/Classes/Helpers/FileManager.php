...
class FileManager extends AbstractHelper {
	 ...
	 * @param \Pipit\Interfaces\File $file An \Interfaces\File
	 * @return void
	 */
	 ...
	 * @param \Pipit\Interfaces\File $file The File to delete
	 * @return boolean Returns true on successful deletion
	 */
	 ...
	 * @param string $fileName The name of the file to retrieve
	 * @return \Pipit\Classes\Data\SimpleFile
	 */
	public function getFileFromFileName($fileName) {
		...
		return new SimpleFile($fileInfo['filename'],null,array_key_exists('extension',$fileInfo) ? $fileInfo['extension']:null,$fileInfo['basename']);
	}
